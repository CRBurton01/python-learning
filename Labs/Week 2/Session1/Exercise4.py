...
# Expression 1
# Prediction: I predict it'll print 14.
result1 = 2 + 3 * 4
print(f"2 + 3 * 4 = {result1}")
# Expression 2
# Prediction: I predict it'll print 20.
result2 = (2 + 3) * 4
print(f"(2 + 3) * 4 = {result2}")
# Expression 3
# Prediction: I predict it'll print 15.0.
result3 = 10 / 2 * 3
print(f"10 / 2 * 3 = {result3}")
# Expression 4
# Prediction: I predict it'll print 1.666666...7
result4 = 10 / (2 * 3)
print(f"10 / (2 * 3) = {result4}")
# Expression 5
# Prediction: I predict it'll print 512.
result5 = 2 ** 3 ** 2
...
my_expression = (8 ** 2) + 40 / 5 - 3
# Prediction: I predict it'll print 64 + 8 - 3 = 69.0.
