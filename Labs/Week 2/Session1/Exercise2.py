...
#    I think these will be the types: int, str, float, str, bool, str
...
str_to_bool = bool(mystery6)
print("Converted mystery6 to boolean:", str_to_bool)
# Yes, string data can be converted to boolean.

# Test Your Understanding
# 1. What type does python choose when adding an integer and a float?
#    Float data
# 2. What happens when you use + with two strings?
#    It concatenates them together
# 3. What int value does True convert to?
#    1
# 4. Is the string "True" the same as the boolean True?
#    No, they are different types. However, non-empty strings convert to True as a boolean.